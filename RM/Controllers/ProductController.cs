...
namespace RM.Controllers
{
    public class ProductController : Controller
    {
        // GET: Product
        [Authorize]
        public ActionResult Index(int? page, int? Id, string sortOrder, string Pages, Products pro)
        {
        ...
        [HttpPost]
        public ActionResult Index(int? page,  string Pages, Products pro)
        {
            string submit = Request["submit"];
